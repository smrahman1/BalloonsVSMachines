...
/**
 *method classes random numbers
                  chapter 6 will have notes
                          arrays search and a sort (seq search and bubble sort)
 * @author smrahman5566
 */
...
//           
       ...
       if (Balloons.x[directioncount]>130 && Balloons.x[directioncount]<350 &&Balloons.y[directioncount]>240&&Balloons.y[directioncount]<300){Balloons.direction[directioncount]=1;}
       else if (Balloons.y[directioncount]<110 && Balloons.y[directioncount]>0 && Balloons.x[directioncount]>300&& Balloons.x[directioncount]<350){Balloons.direction[directioncount]=3;}
       else if (Balloons.y[directioncount]>500 && Balloons.y[directioncount]<550 && Balloons.x[directioncount]>600&& Balloons.x[directioncount]<800){Balloons.direction[directioncount]=1;}
        else if (Balloons.x[directioncount]>620 && Balloons.x[directioncount]<660 && Balloons.y[directioncount]<230&& Balloons.y[directioncount]>0){Balloons.direction[directioncount]=1;}
        else if (Balloons.y[directioncount]<-50){Balloons.direction[directioncount]=0;}
       else{
        ...
        if (Balloons.y[directioncount]<110 &&Balloons.x[directioncount]>100&&Balloons.x[directioncount]<150){Balloons.direction[directioncount]=2;}
        else if (Balloons.y[directioncount]<360 && Balloons.y[directioncount]>330 && Balloons.x[directioncount]>600 && Balloons.x[directioncount]<800){Balloons.direction[directioncount]=4;}
        else if (Balloons.y[directioncount]<210&&Balloons.y[directioncount]>180&& Balloons.x[directioncount]<430 &&Balloons.x[directioncount]>400 ){Balloons.direction[directioncount]=2;}
        else if (Balloons.y[directioncount]<50 &&Balloons.y[directioncount]>0 &&Balloons.x[directioncount]>600 &&Balloons.y[directioncount]<800){Balloons.direction[directioncount]=4;}
        else if (Balloons.y[directioncount]<-50){Balloons.direction[directioncount]=1;}
        else{
        ...
        if (Balloons.y[directioncount]>420&& Balloons.x[directioncount]>300 && Balloons.x[directioncount]<350){Balloons.direction[directioncount]=4;}
        else if (Balloons.y[directioncount]>520&& Balloons.x[directioncount]<90){Balloons.direction[directioncount]=2;}
        else if (Balloons.y[directioncount]<-50){Balloons.direction[directioncount]=0;}
        else{
        Balloons.y[directioncount]+= counter > 0 ? b*i : 0;
        }
        ...
        if (Balloons.x[directioncount]<50){Balloons.direction[directioncount]=3;}
        else if (Balloons.y[directioncount]<360 &&Balloons.y[directioncount]>330&& Balloons.x[directioncount]<430){Balloons.direction[directioncount]=1;}
         else if (Balloons.y[directioncount]<80&& Balloons.x[directioncount]<370){Balloons.direction[directioncount]=1;}
        else if (Balloons.y[directioncount]<-50){Balloons.direction[directioncount]=0;}
         else  {Balloons.x[directioncount]-= counter > 0 ? b*i : 0;
        }
        }
       }
